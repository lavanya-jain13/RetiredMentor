  ...
  const testimonials: Testimonial[] = [
    {
      ...
      company: "TechCorp",
      text: "WisdomWave completely transformed my career. The mentorship I received helped me navigate complex challenges and accelerate my professional growth.",
    ...
    },
    {
      ...
      text: "Finding a mentor in my field was nearly impossible until I discovered WisdomWave. The platform connected me with industry experts who provided invaluable guidance.",
    ...
    },
    {
      ...
      company: "BrandGrowth",
      text: "The quality of mentors on WisdomWave is exceptional. I've been able to learn from leaders in my industry and apply their insights to my own work.",
      ...
      >
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl text-muted-foreground">
            Discover how WisdomWave has helped professionals at all stages of their careers.
          </p>
        </div>
            ...
            >
              <div className="flex">
                {testimonials.map((testimonial) => (
                  <div 
                    key={testimonial.id}
                    className="min-w-full p-10 md:p-16"
                  >
