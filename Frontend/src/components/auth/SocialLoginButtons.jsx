...
export const SocialLoginButtons = ({ isLoading, onGoogleSuccess }) => {
  ...
  return (
    <>
      ...
      <div className=" flex justify-center items-center ">
        <button
          type="button"
          className="flex items-center w-full justify-center gap-2 h-10 rounded-md border bg-background shadow-sm hover:bg-muted transition-colors"
          disabled={isLoading}
